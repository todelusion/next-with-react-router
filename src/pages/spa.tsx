      ...
      <div className="min-h-screen bg-gray-100">
        <nav className="bg-white shadow-lg">
          <div className="max-w-7xl mx-auto px-4">
            ...
            <div className="flex flex-col sm:flex-row items-center h-auto sm:h-14 border-b border-gray-200 py-3 sm:py-0">
              <div className="flex items-center space-x-3 w-full sm:w-64 mb-3 sm:mb-0">
                ...
                <a
                  ...
                  className="sm:hidden inline-flex items-center px-2 py-2 text-sm font-medium text-gray-700 hover:text-gray-900 hover:bg-gray-50 rounded-md transition-colors"
                >
                  <svg
                    className="w-5 h-5"
                    fill="currentColor"
              ...
              <div className="flex flex-wrap justify-center sm:justify-start space-x-2 sm:space-x-6">
                <a
                  href={"/"}
              ...
              <div className="hidden sm:block sm:mt-0 sm:ml-auto">
                <a
                  href="https://github.com/todelusion/next-with-react-router.git"
                  target="_blank"
                  rel="noopener noreferrer"
            ...
            <div className="flex flex-col sm:flex-row items-center h-auto sm:h-14 py-3 sm:py-0">
              <div className="flex items-center space-x-3 w-full sm:w-64 mb-3 sm:mb-0">
